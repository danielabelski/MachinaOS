...
| **[Memory Lifecycle](./docs-internal/memory_lifecycle.md)** | **Stale — pre-RFC-0002.** Documents the retired `input-memory` markdown model. The `services/memory/` helper API, vector store and `claude_code_agent` session bridge sections still hold; the lifecycle and state-clear sections do not. See "Context and Memory (RFC-0002)" below. |
